            ...
            <div class="row">
				...
				<div class="col-md-6 col-xs-12">
                    <ul class="breadcrumb">
                        ...
                        <li class="active" style="color: #fff;">Mi Perfil </li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="featured-boxes">
                ...
                <div class="col-sm-6">
                    ...
                    <div class="featured-box featured-box-primary align-left mt-xlg" style="margin-top: 1px !important">
                        <div class="box-content">
                            <h4 class="heading-primary text-uppercase mb-md">Mi datos personales</h4>
                            <form action="<?php echo URL ?>Usuarios/perfil" method="post">

                                <div class="form-group">
                                    <div class="col-md-6">
                                        <label>Nombre</label>
                                        <input type="text" name="nombres" class="form-control input-md" value="<?php echo $this->usuario->nombresUsuario ?>">
                                    </div>
                                    <div class="col-md-6">
                                        <label>Apellidos</label>
                                        <input type="text" name="apellidos" class="form-control input-md" value="<?php echo $this->usuario->apellidosUsuario ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6">
                                        <label>Email</label>
                                        <input type="text" name="mail" class="form-control input-md" value="<?php echo $this->usuario->emailUsuario ?>">
                                    </div>
                                    <div class="col-md-6">
                                        <label>Comuna</label>
                                ...
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <select class="form-control mb-md" name="genero">
                                            <option value="<?php echo $this->usuario->generoUsuario ?>"><?php echo $this->usuario->generoUsuario ?></option>
                                            <option value=""></option>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="fch_nac" class="form-control input-md" value="<?php echo $this->usuario->fechaNacimientoUsuario ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-6">
                                        <label>Rut</label>
                                        <input type="text" name="rut" class="form-control input-md" value="<?php echo $this->usuario->rutUsuario ?>" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12"><code>Si no desea actualizar su contraseña, deje en blanco los campos.</code></div>

                                    <div class="col-md-6">
                                        <label>Contraseña </label>
                                        <input type="password" name="pw1" class="form-control input-md" value="">
                                    </div>
                                    <div class="col-md-6">
                                        <label>Repita su Contraseña</label>
                                        <input type="password" name="pw2" class="form-control input-md" value="">
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="col-md-12">
                                        <input type="submit" value="Actualizar Datos Personales" class="btn btn-success pull-right mb-xl">
                                    </div>
                                </div>
                            </form>
                        </div>
                ...
                if (empty($this->tramite_part)) {
                    $str_part = '<li>Usted no ha participado en ningún trámite.</li>';
                } else {
                    $count = count($this->tramite_part);
                    for ($i = 0; $i < $count; $i++) {
                        $tramite = (object) $this->tramite_part[$i];
                        $str_part .= '<li><a href="' . URL . 'Tramites/ver/' . $tramite->tituloUrlTramite . '" target="_blank">' . $this->acortar_texto($tramite->tituloTramite, 45) . '</a></li>';
                    }
                }

                if (empty($this->tramite_sug)) {
                    $str_sug = '<li>No existen sugerencias.</li>';
                } else {
                    $count = count($this->tramite_sug);
                    for ($i = 0; $i < $count; $i++) {
                        $tramite = (object) $this->tramite_sug[$i];
                        $str_sug .= '<li><a href="' . URL . 'Tramites/ver/' . $tramite->tituloUrlTramite . '" target="_blank">' . $this->acortar_texto($tramite->tituloTramite, 45) . '</a></li>';
                    }
                }
                ?>
                ...
                <div class="col-sm-3">
                    <div class="ximena">
                        <div class="text-center text-pink">
                            <h4 class="text-pink">Trámites Sugeridos</h4>
                        </div>
                ...
                <div class="col-sm-3">
                    <div class="ximena">
                        <div class="text-center text-pink">
                            <h4 class="text-pink">Trámites en los que he participado</h4>
                        </div>
                        <ul class="nav nav-list">
                            <?php echo $str_part ?>
                        </ul>
