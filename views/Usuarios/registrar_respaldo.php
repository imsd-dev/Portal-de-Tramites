    ...
    <div class="container mt30">
        ...
        <div class="row">
            ...
            <div class="col-md-12 mb30">
                <div class="row">
					<div class="col-md-12">
						<span class="title mb-sm text-center"><strong>Registro de </strong> usuarios </span>
                    ...
                    <div class="col-md-12">
                        <div class="featured-boxes">
                            <div class="row">
								...
								<div class="col-sm-8">
                                    <?php
                                    include './public/templates/mensajes.php';
                                    ...
                                    ?>  
                                    <div class="align-left mt-xlg " style="box-shadow: 0 0 30px rgba(0, 0, 0, 0.2); padding:30px; border-radius:5px;">
                                        <div class="box-content">
                                            <div class="title-t2 heading-primary text-uppercase mb-md">Registro de usuarios</div>
											
									
									
                                            <form action="<?php echo URL ?>Usuarios/registrar" method="post" id="form">

                                                <div class="form-group">
                                                    <div class="col-md-4">  
                                                        <label for="nombres">Nombre <span class="required">*</span></label>
                                                        <input type="text" name="nombres" class="form-control input-md" value="" id="nombres" required title="Favor ingresar su Nombre">
                                                    </div>
                                                    <div class="col-md-4">
                                                         <label for="apellidos">Apellidos <span class="required">*</span></label>
                                                        <input type="text" name="apellidos" class="form-control input-md" id="apellidos" value="" required="" title="Favor ingresar su Apellido"> 
                                                    </div>
													
													<div class="col-md-4">
                                                        <label for="genero" class="control-label">Genero</label>
                                                        <select class="form-control mb-md" name="genero" title="Seleccionar Genero" id="genero"  required >
												...
												<div class="form-group">
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="fch_nac" class="form-control input-md" title="Ingresar Fecha de nacimiento" id="FechaNacimiento" data-plugin-datepicker data-date-format="dd/mm/yyyy" />
                                                        </div>
                                                    </div>
													
													 <div class="col-md-4">
                                                        <label for="mail" >Email <span class="required">*</span></label>
                                                        <input type="email" name="mail" class="form-control input-md" id="mail" title="Ingresar e-mail Válido" value="" required="">
                                                    </div>
													
													 <div class="col-md-4">
                                                        <label for="comuna" >Comuna <span class="required">*</span></label>
                                                        <select class="form-control mb-md" name="comuna" required id="comuna" title="Seleccionar una comuna">
												...
												<div class="col-md-12">
                                                   ...
                                                   <p> <strong> DATOS DE ACCESO A LA PLATAFORMA  </strong> </p>
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-6">
                                                        ...
                                                        <input type="text" name="rut" class="form-control input-md" value="" onblur="this.value = this.value.toUpperCase();esRutTEF(this, 'Rut de Vecino', true, false, true, '101');;validarRUT00(this, true);" id="rut" title="Igresar su rut" required="" >
                                                    </div>
                                                    <div class="col-md-6">
                                                        <label for="contraseña">Contraseña <span class="required">*</span></label>
                                                        <input type="password" name="pw" class="form-control input-md" value="" id="contraseña" title="ingresar una contraseña" required="">
                                                    </div>
                                                </div>
												...
												<div class="alert alert-success">
													...
													<strong>El Rut ingresado </strong>  sera su nombre de  usuario para acceder a la plataforma.
												</div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        <label for="captcha">Escriba el código CAPTCHA </label>
                                                        <input type="text" name="catpcha" class="form-control input-md" value="" id="captcha" title="Favor ingresar codigo de validación (CAPTCHA)" required="">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <!--input  value="Registrarme" class="btn btn-success btn-lg btn-block  mb-xl"-->
														<button type="submit" class="btn btn-success btn-lg btn-block  mb-xl">Crear mi usuario</button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
