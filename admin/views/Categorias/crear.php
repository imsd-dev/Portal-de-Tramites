...
<section role="main" class="content-body">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <form id="form" action="<?php echo URL ?>Categorias/crear" method="post" class="form-horizontal">
                    <div class="col-md-12 col-xl-6">
                        ...
                        <section class="panel">
                            <header class="panel-heading bg-white ">
                                <h5 class="text-weight-semibold text-dark text-uppercase mb-none">Crear nueva categoría</h5>
                                <hr class="mt-md">
                            </header>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="icono_port" class="form-control" title="Ingresar icono de Portada"  required/>
                                    </div>
                                </div> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="icono_int" class="form-control" title="Ingresar icono de Portada"  required/>
                                    </div>
                                </div> 
                            ...
                            <footer class="panel-footer bg-white ">
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary mr-lg pull-right">Agregar categoría </button>
                                </div>
                            </footer>
