...
<section role="main" class="content-body">
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                <form id="form" action="<?php echo URL ?>Preguntas/crear" method="post" class="form-horizontal">
                    <div class="col-md-12 col-xl-6">
                        ...
                        <section class="panel">
                            <header class="panel-heading bg-white ">
                                <h5 class="text-weight-semibold text-dark text-uppercase mb-none">Crear nueva Pregunta Frecuente</h5>
                                <hr class="mt-md">
                            </header>
                            ...
                            <footer class="panel-footer bg-white ">
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary mr-lg pull-right">Agregar Pregunta Frecuente </button>
                                </div>
                            </footer>
