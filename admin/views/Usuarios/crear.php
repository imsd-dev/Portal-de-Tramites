    ...
    <div class="row">
        <div class="col-md-12">
            <div class="row">
                ...
                <form id="form" action="<?php echo URL ?>Usuarios/crear" method="post" class="form-horizontal">
                    <div class="col-md-12 col-xl-6">

                        <section class="panel">
                            <header class="panel-heading bg-white ">
                                <h5 class="text-weight-semibold text-dark text-uppercase mb-none">Crear nuevo usuario</h5>
                                <hr class="mt-md">
                            </header>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <div class="input-group">
                                            ...
                                            <input name="fch_nac" type="text" data-plugin-datepicker class="form-control">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="run" class="form-control" title="Debe ingresar un run válido" onblur="checkRutPersona(this);" required/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-3 control-label">Contraseña <span class="required">*</span></label>
                                    <div class="col-sm-9">
                                        <input type="text" name="pwd" class="form-control" title="Debe ingresar una contraseña"  required/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="checkbox-custom chekbox-primary">
                                            <input id="activo" value="activo" type="checkbox" name="for[]"   />
